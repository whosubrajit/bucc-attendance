...
export default async function LandingPage({
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-navy-900 via-navy-800 to-navy-950 px-4 text-white overflow-hidden">
      {member && <HangingIdCard member={member} />}
      <div className={`w-full max-w-md text-center relative z-10 ${member ? 'mt-[400px]' : ''}`}>
        {!member && (
          <>
            <div className="mx-auto mb-8 flex justify-center">
              <img src="/bucc-logo.png" alt="BUCC Logo" className="h-20 w-auto object-contain drop-shadow-xl" />
            </div>
